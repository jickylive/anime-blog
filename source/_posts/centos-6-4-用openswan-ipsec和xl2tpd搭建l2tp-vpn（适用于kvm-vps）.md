...
如果找不到的软件，那么可以去[http://pkgs.org/](http://pkgs.org/)找rpm包。比如xl2tpd我就找不到，去pkgs.org就可以搜到：

CentOS 6

Atomic:

*   [xl2tpd-1.2.7-1.el6.art.i686.rpm](http://pkgs.org/centos-6/atomic-i386/xl2tpd-1.2.7-1.el6.art.i686.rpm.html)Layer 2 Tunnelling Protocol Daemon (RFC 2661)
*   [xl2tpd-1.2.7-1.el6.art.x86\_64.rpm](http://pkgs.org/centos-6/atomic-x86_64/xl2tpd-1.2.7-1.el6.art.x86_64.rpm.html)Layer 2 Tunnelling Protocol Daemon (RFC 2661)

EPEL:

*   [xl2tpd-1.3.1-7.el6.i686.rpm](http://pkgs.org/centos-6/epel-i386/xl2tpd-1.3.1-7.el6.i686.rpm.html)Layer 2 Tunnelling Protocol Daemon (RFC 2661)
*   [xl2tpd-1.3.1-7.el6.x86\_64.rpm](http://pkgs.org/centos-6/epel-x86_64/xl2tpd-1.3.1-7.el6.x86_64.rpm.html)Layer 2 Tunnelling Protocol Daemon (RFC 2661)

根据自己的系统是i686还是x86\_64找个对应的最新的[xl2tpd-1.3.1-7](http://pkgs.org/centos-6/epel-i386/xl2tpd-1.3.1-7.el6.i686.rpm.html)下下来安装。其他包找不到同理一样做。都要找最新的！

yum install xl2tpd-1.3.1-7.el6.x86\_64.rpm
...
Checking for IPsec support in kernel                            \[OK\]
 ...
 NETKEY:  Testing for disabled ICMP send\_redirects              \[OK\]
